...
def callback_snake_laser(data):
    global lastLaser_snake, laser_pub_snake
...
def callback_duck_laser(data):
    global lastLaser_duck, laser_pub_duck
...
def publish_tf():
    ...
    global lastLaser_duck, laser_sub_duck, laser_pub_duck
    ...
    # laser_pub_snake = rospy.Publisher("/snake/updatedScan", LaserScan, queue_size=10)
