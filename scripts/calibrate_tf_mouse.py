...
if __name__ == '__main__':
    ...
    rospy.init_node('calibrate_mouse')

    # t = geometry_msgs.msg.TransformStamped()
    # br = tf2_ros.TransformBroadcaster()

    laserList1 = rospy.Subscriber("/mouse/scan0", LaserScan, updateLaser, queue_size=1)
    bg_pub = rospy.Publisher('/bg_cloud1', PointCloud, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        pc_li.header.frame_id = "bg_cloud1"
